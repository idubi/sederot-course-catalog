...
- Start no application implementation on `main`; use the exact task branch.
- Verify dependencies are merged before activating a task.
- Load every required skill and follow the linked task checklist.
- A task needs tests, documentation, evidence, an individual PR, review, and approved merge before completion.
...
- **Required skills:** development-lifecycle, git-task-workflow
...
- **Pull request:** Required; one focused PR, never auto-merged.
...
- **Required skills:** development-lifecycle, git-task-workflow, brainstorming
- **Source documents:** `AGENTS.md`, `artifacts/SDD.md`, `artifacts/Sderot_Courses_Detailed_Design_v1.0.docx`, current task file
...
- **Required skills:** development-lifecycle, git-task-workflow, brainstorming, content-import
...
- **Required skills:** development-lifecycle, git-task-workflow, content-import
- **Source documents:** `AGENTS.md`, `artifacts/SDD.md`, `artifacts/Sderot_Courses_Detailed_Design_v1.0.docx`, current task file, `artifacts/content-import.md`, actual תשפ״ז source DOCX when present
