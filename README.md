...
ניתן גם לטעון מסמך Blueprint בפורמט Markdown או טקסט; העורך ממיר אותו לטיוטת
ה-Schema הקרובה ביותר ומציג אבחונים מובנים לכל שדה חסר או ערך לא ודאי. לאחר
ההמרה ממשיכים לערוך את אותו JSON בממשק.
