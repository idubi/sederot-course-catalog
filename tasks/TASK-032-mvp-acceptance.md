# TASK-032 — Final MVP acceptance review
...
`task/032-mvp-acceptance`

## Objective

Trace all Must/Should use cases and SDD constraints to evidence, obtain business approval, and record release readiness/follow-ups.
...
- [ ] Audit UC/requirements
- [ ] content sample and every registration target
- [ ] exclusions/privacy
- [ ] known risks
- [ ] business sign-off
- [ ] release decision
...
- [ ] Run full gates and final remote smoke
- [ ] document exact versions/URLs/results
- [ ] Run relevant regression checks and `git diff --check`.
- [ ] Record exact commands and results under Completion evidence.

## Documentation checklist

- [ ] Finalize acceptance, operations, release notes, and follow-up backlog
...
- All Must criteria have evidence, owner approval is recorded, and no unresolved release blocker remains.
