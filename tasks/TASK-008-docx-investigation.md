# TASK-008 — DOCX parser investigation
...
`task/008-docx-investigation`

## Objective

Inspect the actual תשפ״ז DOCX structure read-only and record parser anchors, anomalies, counts, and uncertainty before importer implementation.
...
- [ ] Locate actual source
- [ ] inventory paragraphs/tables/styles/lists
- [ ] sample programs/groups/descriptions
- [ ] record uncertain patterns
- [ ] Preserve unrelated work and keep the change within this task.
- [ ] Update this checklist and the master checklist consistently.

## Testing checklist

- [ ] Run repeatable inspection and capture baseline counts/checksums without modifying DOCX
- [ ] Run relevant regression checks and `git diff --check`.
- [ ] Record exact commands and results under Completion evidence.

## Documentation checklist

- [ ] Record findings, gaps, and parser strategy
...
- Investigation proves source unchanged and gives enough evidence to design the parser.
